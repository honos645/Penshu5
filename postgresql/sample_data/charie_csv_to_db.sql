...
\COPY entrance_route ./entrance_route.csv DELIMITER AS ','
...
\COPY subject_classification_graduate.csv FROM ./subject_classification_graduate.csv DELIMITER AS ','
\COPY subject_grade FROM ./subject_grade.csv DELIMITER AS ','
\COPY subject_detail FROM ./subjectDetail.csv DELIMITER AS ','
